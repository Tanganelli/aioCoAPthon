...
from aiocoapthon.utilities import utils
from aiocoapthon.messages.response import Response
from aiocoapthon.tests.plugtest_observe_resources import *
...
class PlugtestObserveClientClass(unittest.TestCase):  # pragma: no cover
    def setUp(self):
